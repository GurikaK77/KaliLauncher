...
function getModpackFilesRoot() {
    return path.join(__dirname, 'modpack_files').replace(/app\.asar([/\\])/, 'app.asar.unpacked$1');
}
...
function getResourceCoverRoot() {
    return path.join(__dirname, 'assets', 'modpack-covers').replace(/app\.asar([/\\])/, 'app.asar.unpacked$1');
}
